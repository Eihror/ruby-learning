...
As the time went by I've decided to that I wanted to learn Ruby. But, why Ruby?
Ruby is "growing up" each and every day. Your gems allow you to accomplish awesome things and it's easy to integrate with Angular.js for example making your applications more resilient thus catching companies attention and having them starting to use Ruby.
